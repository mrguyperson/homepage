...
Analytical and detail-oriented data scientist with 7+ years of experience using machine learning, simulation, and statistical analysis to solve complex problems. Proven track record in building predictive models, automating workflows, and delivering insights to non-technical stakeholders. Skilled in Python, R, SQL, and Docker, with a passion for reproducibility and open-source solutions. Looking to apply strong quantitative skills and a scientific mindset to business challenges in data-driven organizations.
